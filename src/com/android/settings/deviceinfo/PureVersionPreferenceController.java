...
public class PureVersionPreferenceController extends PreferenceController {
    ...
    public boolean isAvailable() {
        return !TextUtils.isEmpty(SystemProperties.get(PROPERTY_PURE_VERSION));
    }

    @Override
    public String getPreferenceKey() {
        return KEY_PURE_VERSION;
    }

    @Override
    public void displayPreference(PreferenceScreen screen) {
        super.displayPreference(screen);
        final Preference pref = screen.findPreference(KEY_PURE_VERSION);
        if (pref != null) {
            final String summary = SystemProperties.get(PROPERTY_PURE_VERSION,
                    mContext.getResources().getString(R.string.pure_version_default));
